...
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Imhlcm9hc3NvY2lhdGlvbiIsImlkIjoxLCJpYXQiOjE1OTQzMDk5NTJ9.yL8DTWc8subkIAS-mWtRkY5TPNowtNCffAh4TMrjkEI';
...
describe('Heroes API test', function () {
  ...
  it('Should read only 1 hero', async () => {
    const NAME = MOCK_HERO_UPDATE.nome;
    const result = await app.inject({
      method: 'GET',
